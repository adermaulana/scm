			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($name != null && $price != null && $unit != null && $category != null && $rdbStock == 1) {
					...
					if(mysqli_query($con,$query_UpdateProduct)) {
						echo "<script> alert(\"Produk Berhasil Update\"); </script>";
...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="product:name" name="txtProductName" placeholder="Nama Produk" value="<?php echo $row_selectProductDetails['pro_name']; ?>" required /> </div> <span class="error_message"><?php echo $nameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="product:price">Harga</label> </div>
			<div class="input-box"> <input type="text" id="product:price" name="txtProductPrice" placeholder="Harga" value="<?php echo $row_selectProductDetails['pro_price']; ?>" required /> </div> <span class="error_message"><?php echo $priceErr; ?></span>
		</li>
		<li>
		...
		<li>
			<input type="submit" value="Ubah Produk" class="submit_button" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
