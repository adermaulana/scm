...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"><textarea id="categoryDetails" name="txtCategoryDetails" placeholder="Detail"><?php echo $row_selectCategoryDetails['cat_details']; ?></textarea> </div>
		</li>
		<li>
